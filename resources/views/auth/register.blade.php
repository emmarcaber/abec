    ...
    <form method="POST" action="{{ route('register') }}">
        ...
        <div class="mt-4">
            ...
            <div class="ml-8 flex justify-center gap-4" id>
                <label for="executive_type" class="font-medium text-sm text-gray-700 dark:text-gray-300'">
                    <input type="radio"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
                        id="executive_type" value="executive" name="officer_type" checked />
                    Executive</label>

                <label for="committee_type" class="font-medium text-sm text-gray-700 dark:text-gray-300'">
                    <input type="radio"
                        class="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600"
