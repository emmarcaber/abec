                    ...
                    <form method="POST" action="{{ route('user.evaluations.store') }}">
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-sm text-justify">
                                This criterion evaluates the individual's understanding and proficiency in their role or
                                field. It assesses how well the individual applies their knowledge to tasks and stays
                                updated on relevant information. Factors to consider include problem-solving skills,
                                technical competence, and practical application of knowledge.
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-sm text-justify">
                                Leadership abilities focus on an individual's capacity to guide, motivate, and influence
                                others towards common goals. It involves assessing communication skills, decision-making
                                capabilities, and the ability to inspire and empower team members. Factors to consider
                                may include strategic thinking, conflict resolution skills, and leading by example.
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-sm text-justify">
                                This criterion evaluates how well an individual works with others towards shared
                                objectives. It includes assessing communication within the team, willingness to support
                                colleagues, and positive contributions to group dynamics. Factors to consider may
                                include cooperation, adaptability, and fostering a collaborative work environment.
                            </div>
                            ...
                            <div
                                ...
                                <label for="tc_OK" class="flex justify-center items-center gap-2">
                                    <input type="radio" id="tc_OK" name="teamwork_collaboration"
                                        value="3" required />
                                    OK
                                </label>
                                <label for="tc_fair" class="flex justify-center items-center gap-2">
                                    <input type="radio" id="tc_fair" name="teamwork_collaboration"
                                        value="2" required />
                                    Fair
                                </label>
                                <label for="tc_poor" class="flex justify-center items-center gap-2">
                                    <input type="radio" id="tc_poor" name="teamwork_collaboration"
                                        value="1" required />
                                    Poor
                                </label>
                            </div>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-sm text-justify">
                                ...
                                in fulfilling responsibilities. It involves evaluating punctuality, quality of work
                                produced, and going beyond expectations when necessary. Factors to consider may include
                                time management skills, attention to detail, and consistency in meeting deadlines.
                            </div>

                            <div
                                class="mt-2 flex flex-col justify-center items-center md:flex-row md:justify-center md:items-center md:gap-28 text-md">
                                <label for="wed_excellent" class="flex justify-center items-center gap-2">
                                    <input type="radio" id="wed_excellent" name="work_ethic_dedication"
                                        value="5" required />
                                    Excellent
                                </label>
                        ...
                        <div class="mt-4">
                            ...
                            <div class="text-sm text-justify">
                                ...
                                success. It considers how effectively the individual's work aligns with team goals,
                                enhances productivity, and contributes positively to the work environment. Factors may
                                include initiative-taking, problem-solving contributions, and supporting team objectives
                                effectively.
                            </div>
                            ...
                            <div
                                ...
                                <label for="octt_good" class="flex justify-center items-center gap-2">
                                    <input type="radio" id="octt_good" name="overall_contribution_to_team"
                                        value="4" required />
                                    Good
                                </label>
                                <label for="octt_OK" class="flex justify-center items-center gap-2">
                                    <input type="radio" id="octt_OK" name="overall_contribution_to_team"
                                        value="3" required />
                                    OK
                                </label>
                                <label for="octt_fair" class="flex justify-center items-center gap-2">
                                    <input type="radio" id="octt_fair" name="overall_contribution_to_team"
                                        value="2" required />
                                    Fair
                                </label>
                                <label for="octt_poor" class="flex justify-center items-center gap-2">
                                    <input type="radio" id="octt_poor" name="overall_contribution_to_team"
                                        value="1" required />
                                    Poor
                                </label>
                            </div>
