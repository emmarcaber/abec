                            ...
                            <form class="max-w-lg sm:max-w-md mx-auto">
                                ...
                                <div class="relative">
                                    ...
                                    <input type="search" id="default-search"
                                        ...
                                        placeholder="Search Position, Officer Name" required />
                                </div>
                            </form>
                        </div>
                                    ...
                                    <tr
                                        ...
                                        <td
                                            ...
                                            <button data-modal-target="view-modal-{{ $evaluation->id }}"
                                                ...
                                                class="font-medium text-blue-600 dark:text-blue-500 rounded-md focus:ring-4 focus:ring-blue-300">
                                            ...
                                            <button type="button" data-modal-target="edit-modal-{{ $evaluation->id }}"
                                                data-modal-toggle="edit-modal-{{ $evaluation->id }}"
                                                class="font-medium text-amber-600 dark:text-amber-500 rounded-md focus:ring-4 focus:ring-amber-300">
                                                <svg xmlns="http://www.w3.org/2000/svg" fill="none"
                                                    viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor"
                                                    class="w-6 h-6">
                                                    <path stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <x-evaluations.edit-modal :$evaluation />
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
